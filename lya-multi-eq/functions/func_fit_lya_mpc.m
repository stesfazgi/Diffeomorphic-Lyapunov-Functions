function [alpha_star, z_train_H1, loss] = func_fit_lya_mpc(phi, x_train, f_target, H_vec, V, prev_alpha_hor, hor)
...
%   loss            Scalar representing the final loss of the optimization
    ...
    obj = @(a) func_fit_lya_mpc_loss_fmincon(Jz_train, z_train_H1, f_target, H_vec, V, a);
    ...
    [alpha_star, loss] = fmincon(obj, alpha_init, [], [], [], [], alpha_lb, alpha_ub, [], []);
